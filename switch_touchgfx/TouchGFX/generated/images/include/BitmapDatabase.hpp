...
const uint16_t BITMAP_BLUE_TOGGLEBARS_TOGGLE_SMALL_BUTTON_OFF_ID = 2; // Size: 96x38 pixels
const uint16_t BITMAP_BLUE_TOGGLEBARS_TOGGLE_SMALL_BUTTON_ON_ID = 3; // Size: 96x38 pixels
